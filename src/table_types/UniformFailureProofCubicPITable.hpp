/*
  ...
  Usage example:
    UniformFailureProofCubicPITable look(&function,0,10,0.0001);
...
class UniformFailureProofCubicPITable final : public UniformLookupTable
{
  REGISTER_ULUT(UniformFailureProofCubicPITable);
  #ifndef NDEBUG
...
public:
  ...
  ~UniformFailureProofCubicPITable();
};
