...
REGISTER_ULUT_IMPL_DIFF(3,IMPL_NAME);

UniformCubicTaylorTable::UniformCubicTaylorTable(EvaluationFunctor<autodiff_fvar<double,3>,autodiff_fvar<double,3>> *func, UniformLookupTableParameters par) :
